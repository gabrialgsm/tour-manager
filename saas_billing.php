...
<section class="hero"><div><span class="plan-badge"><?=saas_h($plan['name'])?> plan</span><h2><?=saas_h($plan['description'])?></h2><p class="muted">Subscription status: <?=saas_h($plan['subscription_status'])?> · <?=saas_h($plan['currency'])?> <?=number_format((float)$plan['monthly_price'],2)?>/month</p></div><div><a class="btn ghost" href="saas_team.php">Team</a></div></section>
