...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    try {
        ...
        $u=$q->fetch();
        $valid=false;
        if ($u && in_array($u['status'], ['ACTIVE','PENDING'], true)) $valid=password_verify($password,(string)$u['password_hash']);
