...
if($_SERVER['REQUEST_METHOD']==='POST'){
    try{
        ...
        if($email===''||!filter_var($email,FILTER_VALIDATE_EMAIL)) throw new RuntimeException('A valid email address is required.');
